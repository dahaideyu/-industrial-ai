...
| 连接方式 | 状态 | 说明 |
|---------|------|------|
| MySQL 127.0.0.1:13306 → 218.90.129.90:23306 | ❌ 被拦截 | 企业代理不允许 CONNECT 到 23306 |
| PostgreSQL 127.0.0.1:15432 → 218.90.129.90:5432 | ✅ 正常 | 5432 端口被代理白名单放行 |
...
Tunnel      13306:218.90.129.90:23306
Tunnel      15432:218.90.129.90:5432
```
